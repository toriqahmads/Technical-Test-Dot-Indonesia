...
export class PostApi implements IApi {
  ...
  async find(): Promise<[PostDto]> {
    const response: axios.AxiosResponse = await axios.default.get(
      `${this.baseEndpoint}${this.basePath}`,
    );
  ...
  async findOne(id: number): Promise<PostDto> {
    const response: axios.AxiosResponse = await axios.default.get(
      `${this.baseEndpoint}${this.basePath}/${id}`,
    );
    return response.data;
  }
  ...
  async edit(id: number, entities: EditPostDto): Promise<PostDto> {
    const response: axios.AxiosResponse = await axios.default.patch(
      `${this.baseEndpoint}${this.basePath}/${id}`,
      entities,
    );
    return response.data;
  ...
  async editPut(id: number, entities: EditPutPostDto): Promise<PostDto> {
    const response: axios.AxiosResponse = await axios.default.put(
      `${this.baseEndpoint}${this.basePath}/${id}`,
      entities,
    );
    return response.data;
  ...
  async remove(id: number): Promise<PostDto> {
    const response: axios.AxiosResponse = await axios.default.delete(
      `${this.baseEndpoint}${this.basePath}/${id}`,
    );
    return response.data;
  }
